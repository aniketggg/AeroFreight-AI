"""
Wraps uAgents' built-in Payment Protocol (seller role) so the settlement
agent can receive CommitPayment / RejectPayment messages without
duplicating boilerplate in the main agent file.
"""
